...
-- Description:	ICO - Maintenance Ready Sprocable
-- =============================================
CREATE PROCEDURE [dbo].[RPT_WKO_MakeReadyStatistics] 
...
BEGIN
	...
	-- Copied from move outs on RPT_RES_ResidentActivity
	INSERT #UnitStats
		SELECT	DISTINCT
				u.UnitID,
				p.PropertyID,
	...
	UPDATE #UnitStats SET ExpectedMoveInDate = (SELECT TOP 1 pl.MoveInDate
													...
													WHERE ulg.UnitID = #UnitStats.UnitID
													  AND pl.MoveInDate >= #UnitStats.MoveOutDate
	...
	SELECT * 
		FROM #UnitStats
		ORDER BY PaddedUnitNumber, MoveOutDate
