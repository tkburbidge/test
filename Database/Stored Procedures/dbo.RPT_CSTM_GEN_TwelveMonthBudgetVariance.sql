...
CREATE PROCEDURE [dbo].[RPT_CSTM_GEN_TwelveMonthBudgetVariance] 
...
--select * from #PropertiesAndDates order by PropertyID, MonthSequence
	...
	UPDATE #ConsolodatedReturnNumbers SET Month4Balance = ISNULL((SELECT Balance
																	  FROM #MyTempBalanceTable
																		  WHERE MonthSequence = 4
																			AND GLAccountID = #ConsolodatedReturnNumbers.GLAccountID
																			AND PropertyID = #ConsolodatedReturnNumbers.PropertyID), 0)

	UPDATE #ConsolodatedReturnNumbers SET Month5Balance = ISNULL((SELECT Balance
																	  FROM #MyTempBalanceTable
																		  WHERE MonthSequence = 5
																			AND GLAccountID = #ConsolodatedReturnNumbers.GLAccountID
																			AND PropertyID = #ConsolodatedReturnNumbers.PropertyID), 0)

	UPDATE #ConsolodatedReturnNumbers SET Month6Balance = ISNULL((SELECT Balance
																	  FROM #MyTempBalanceTable
																		  WHERE MonthSequence = 6
																			AND GLAccountID = #ConsolodatedReturnNumbers.GLAccountID
																			AND PropertyID = #ConsolodatedReturnNumbers.PropertyID), 0)

	UPDATE #ConsolodatedReturnNumbers SET Month7Balance = ISNULL((SELECT Balance
																	  FROM #MyTempBalanceTable
																		  WHERE MonthSequence = 7
																			AND GLAccountID = #ConsolodatedReturnNumbers.GLAccountID
																			AND PropertyID = #ConsolodatedReturnNumbers.PropertyID), 0)

	UPDATE #ConsolodatedReturnNumbers SET Month8Balance = ISNULL((SELECT Balance
																	  FROM #MyTempBalanceTable
																		  WHERE MonthSequence = 8
																			AND GLAccountID = #ConsolodatedReturnNumbers.GLAccountID
																			AND PropertyID = #ConsolodatedReturnNumbers.PropertyID), 0)

	UPDATE #ConsolodatedReturnNumbers SET Month9Balance = ISNULL((SELECT Balance
																	  FROM #MyTempBalanceTable
																		  WHERE MonthSequence = 9
																			AND GLAccountID = #ConsolodatedReturnNumbers.GLAccountID
																			AND PropertyID = #ConsolodatedReturnNumbers.PropertyID), 0)

	UPDATE #ConsolodatedReturnNumbers SET Month10Balance = ISNULL((SELECT Balance
																	  FROM #MyTempBalanceTable
																		  WHERE MonthSequence = 10
																			AND GLAccountID = #ConsolodatedReturnNumbers.GLAccountID
																			AND PropertyID = #ConsolodatedReturnNumbers.PropertyID), 0)

	UPDATE #ConsolodatedReturnNumbers SET Month11Balance = ISNULL((SELECT Balance
																	  FROM #MyTempBalanceTable
																		  WHERE MonthSequence = 11
																			AND GLAccountID = #ConsolodatedReturnNumbers.GLAccountID
																			AND PropertyID = #ConsolodatedReturnNumbers.PropertyID), 0)

	UPDATE #ConsolodatedReturnNumbers SET Month12Balance = ISNULL((SELECT Balance
																	  FROM #MyTempBalanceTable
																		  WHERE MonthSequence = 12
																			AND GLAccountID = #ConsolodatedReturnNumbers.GLAccountID
																			AND PropertyID = #ConsolodatedReturnNumbers.PropertyID), 0)
	...
	BEGIN
		SELECT
				...
				SUM(#crn.Month1Balance) AS 'Month1Balance',
				SUM(#crn.Month2Actual) AS 'Month2Amount',
				SUM(#crn.Month2Budget) AS 'Month2Budget',
				SUM(#crn.Month2Balance) AS 'Month2Balance',
				SUM(#crn.Month3Actual) AS 'Month3Amount',
				SUM(#crn.Month3Budget) AS 'Month3Budget',
				SUM(#crn.Month3Balance) AS 'Month3Balance',
				SUM(#crn.Month4Actual) AS 'Month4Amount',
				SUM(#crn.Month4Budget) AS 'Month4Budget',
				SUM(#crn.Month4Balance) AS 'Month4Balance',
				SUM(#crn.Month5Actual) AS 'Month5Amount',
				SUM(#crn.Month5Budget) AS 'Month5Budget',
				SUM(#crn.Month5Balance) AS 'Month5Balance',
				SUM(#crn.Month6Actual) AS 'Month6Amount',
				SUM(#crn.Month6Budget) AS 'Month6Budget',
				SUM(#crn.Month6Balance) AS 'Month6Balance',
				SUM(#crn.Month7Actual) AS 'Month7Amount',
				SUM(#crn.Month7Budget) AS 'Month7Budget',
				SUM(#crn.Month7Balance) AS 'Month7Balance',
				SUM(#crn.Month8Actual) AS 'Month8Amount',
				SUM(#crn.Month8Budget) AS 'Month8Budget',
				SUM(#crn.Month8Balance) AS 'Month8Balance',
				SUM(#crn.Month9Actual) AS 'Month9Amount',
				SUM(#crn.Month9Budget) AS 'Month9Budget',
				SUM(#crn.Month9Balance) AS 'Month9Balance',
				SUM(#crn.Month10Actual) AS 'Month10Amount',
				SUM(#crn.Month10Budget) AS 'Month10Budget',
				SUM(#crn.Month10Balance) AS 'Month10Balance',
				SUM(#crn.Month11Actual) AS 'Month11Amount',
				SUM(#crn.Month11Budget) AS 'Month11Budget',
				SUM(#crn.Month11Balance) AS 'Month11Balance',
				SUM(#crn.Month12Actual) AS 'Month12Amount',
				SUM(#crn.Month12Budget) AS 'Month12Budget',
				SUM(#crn.Month12Balance) AS 'Month12Balance',
